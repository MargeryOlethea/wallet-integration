...
export async function signEvmWithKeplrEdited({
  client, // SigningStargateClient
  ...
  try {
    ...
    const accountRes = await fetch(
      `https://froopyland-public.api.silknodes.io/cosmos/auth/v1beta1/accounts/${signerAddress}`,
    );
    ...
    isDev && console.log("from signer sign direct", { signature, signed });
...
// export async function simulateEvmWithKeplrEdited({
//   client, // SigningStargateClient
//   signer, // keplr OfflineSigner
//   chain,
//   signerAddress,
